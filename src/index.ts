...
export class Justement extends Core.APIClient {
  ...
  constructor({
    ...
    super({
      ...
      baseURLOverridden: baseURL ? baseURL !== 'https://justement.ch' : false,
    ...
    const customHeadersEnv = Core.readEnv('JUSTEMENT_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://justement.ch';
  }
