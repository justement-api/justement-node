...
export class Count extends APIResource {
  /**
   * Count the number of documents matching the search criteria.
   */
  execute(query?: CountExecuteParams, options?: Core.RequestOptions): Core.APIPromise<CountExecuteResponse>;
  execute(options?: Core.RequestOptions): Core.APIPromise<CountExecuteResponse>;
  execute(
    query: CountExecuteParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<CountExecuteResponse> {
...
export type CountExecuteResponse = number;

export interface CountExecuteParams {
  /**
...
export declare namespace Count {
  export { type CountExecuteResponse as CountExecuteResponse, type CountExecuteParams as CountExecuteParams };
}
